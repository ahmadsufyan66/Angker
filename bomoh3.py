...
pygame.mixer.music.load("Sound/Soundcombat page background sound.mp3")
...
#Background
background = pygame.image.load('assets/bomoh3_bg.jpg')
...
player2 = Player("Player 2", False, 120, aggressiveness = 1.2,)  # ai
