...
#Background
background = pygame.image.load('assets/bomoh2_bg.jpg')
...
player2 = Player("Player 2", False, 100, aggressiveness = 0.9,)  # AI
...
player1_turn = True
difficulty_level = "medium"  # Adjust difficulty level here
